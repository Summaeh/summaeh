# -*- coding: utf-8 -*-
"""
Django settings for summaeh project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'summaeh.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Time Summaeh""", 'fabiomacedomendes@gmail.com'),
]
...
ACCOUNT_ADAPTER = 'summaeh.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'summaeh.users.adapters.SocialAccountAdapter'
